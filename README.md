...
### v0.2.0 - 多语言国际化支持
- 🌐 **完整国际化** - 所有 UI 文本支持中英文双语
- 🔄 **语言切换** - 设置页面支持实时切换语言，自动保存偏好
- 📝 **README 多语言** - 中英文版本互相导航链接
- ✨ **100% 覆盖** - 19个组件全部完成国际化替换
- 🌍 **i18next 集成** - 使用 react-i18next + i18next-browser-languagedetector

### v2.2 - 修复与优化
- 🔧 **修复密码验证** - 修复应用启动时密码验证逻辑错误
- 🔧 **修复详情刷新** - 修复编辑后右侧详情面板不刷新问题
- ✨ **手动锁定** - 新增锁定按钮和 Ctrl+L 快捷键
